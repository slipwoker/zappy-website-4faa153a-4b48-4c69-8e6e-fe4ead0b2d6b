document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateForm(form) {
    ...
    fields.forEach(function (field) {
      ...
      if (isRequired && value === '') {
        ...
        var fieldName = label ? label.textContent.replace('*', '').trim() : (field.placeholder || 'This field');
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function (e) {
      var isValid = validateForm(contactForm);
      if (!isValid) {
        e.preventDefault();
        ...
        if (firstError) {
          ...
          var elementTop = firstError.getBoundingClientRect().top + window.pageYOffset;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4faa153a-4b48-4c69-8e6e-fe4ead0b2d6b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4faa153a-4b48-4c69-8e6e-fe4ead0b2d6b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4faa153a-4b48-4c69-8e6e-fe4ead0b2d6b';
